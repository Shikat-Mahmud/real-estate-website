                        ...
                        <div class="mb-3 form-group">
                            ...
                            <select name="property_type_id" id="property_type_id" class="form-control" required>
                                ...
                                @foreach ($property_types as $item)
                                    <option {{ $property->property_type_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="mb-3 form-group">
                            ...
                            <select name="location_id" id="location_id" class="form-control" required>
                                ...
                                @foreach ($locations as $item)
                                    <option {{ $property->location_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="mb-3 form-group">
                            ...
                            <select name="property_status_id" id="property_status_id" class="form-control" required>
                                ...
                                @foreach ($property_status as $item)
                                    <option {{ $property->property_status_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" name="price" required
                                value="{{ $property->price }}" placeholder="Property Price">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" name="sqft"
                                value="{{ $property->sqft }}" placeholder="Property Sqft" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" name="unit"
                                value="{{ $property->unit }}" placeholder="Unit" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" name="room"
                                value="{{ $property->room }}" placeholder="Total Room" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" name="bed_room"
                                value="{{ $property->bed_room }}" placeholder="Total Bed Room" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" name="bathroom"
                                value="{{ $property->bathroom }}" placeholder="Total Bathroom" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" name="floor"
                                value="{{ $property->floor }}" placeholder="Floor" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" name="kitchen"
                                value="{{ $property->kitchen }}" placeholder="Total Kitchen" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" name="parking"
                                value="{{ $property->parking }}" placeholder="Total Parking" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" name="year"
                                value="{{ $property->year }}" placeholder="Built Year" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3 form-group">
                            <label for="type" class="form-label">Structure Type <span class="text-danger">
                                    *</span></label>
                            <input type="text" class="form-control" name="structure_type"
                                value="{{ $property->structure_type }}" placeholder="Structure Type" required>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card mt-3">
            <div class="card-body">
                <div class="mt_35">
                    <h5>Aminities</h5>
                    @php 
                    $old_amenities = json_decode($property->amenities);
                    @endphp
                    <div class="row">
                        @foreach ($amenities ?? [] as $item)
                            <div class="col-xl-4 col-sm-6 col-lg-4">
                                ...
                                <input class="form-check-input is-check" type="checkbox" name="aminities[]"
                                           ...
                                           {{ is_array($old_amenities) && in_array($item->id, $old_amenities) ? 'checked' : '' }}>
        ...
        <div class="card mt-3">
            <div class="card-body">
                <div class="mt-3">
                    ...
                    @php
                        $old_places = json_decode($property->nearest_places);
                    @endphp
        
                    <div class="col-md-12">
                        <table class="table table-bordered" id="dynamic_field">
                            @foreach($old_places ?? [] as $key => $value)
                            <tr data-key="{{ $key }}">
                                <td width="33.33%">
                                    <select name="nearest_places[{{ $key }}][place_id]" class="form-control">
                                        <option value="">Select Property Type </option>
                                        @foreach ($nearests as $item)
                                            <option {{ $item->id == $value->place_id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </td>
                                <td width="33.33%">
                                    <input type="text" name="nearest_places[{{ $key }}][distance]" placeholder="Enter distance" value="{{ $value->distance }}" class="form-control name_list" />
                                </td>
                                <td width="33.33%">
                                    <button type="button" data-key="{{ $key }}" name="remove" id="{{ $key }}" class="btn btn-danger btn_remove">X</button>
                                </td>
                            </tr>
                        @endforeach
                        </table>
                ...
                <div class="mt_35">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3 form-group">
                            ...
                            <textarea name="map" class="form-control">{{ $property->map }}</textarea>
                        </div>
                        <div class="col-md-12 mb-3 form-group">
                            <label for="">Description <span class="text-danger">*</span></label>
                            <textarea name="description" class="form-control" id="myeditorinstance">{{ $property->description }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card mt-3">
            <div class="card-body">
                <div class="mt_35">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3 form-group">
                            <input name="video_url" class="form-control" value="{{ $property->video_url }}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3 form-group">
                            ...
                            <select name="status" class="form-control">
                                <option {{ $property->status == 0 ? 'selected' : '' }} value="0">Active </option>
                                <option {{ $property->status == 1 ? 'selected' : '' }} value="1">Inactive</option>
                            </select>
                        </div>
                    </div>
                </div>
